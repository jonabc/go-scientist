...
func RunAsyncCandidatesOnly(ctx context.Context, e *Experiment, controlBehavior string) Result {
	...
	go func(ctx context.Context, e *Experiment, control *Observation) {
	...
	}(context.WithoutCancel(ctx), e, r.Control)
...
func observe(ctx context.Context, e *Experiment, name string, b behaviorFunc) (o *Observation) {
	o = &Observation{
		Experiment: e,
		Name:       name,
		Started:    time.Now(),
